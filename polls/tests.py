...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() should return False for questions whose pub date older than a day
        """
        time = timezone.now() - datetime.timedelta(days=30)
        future_question = Question(pub_date=time)
    ...
    def test_was_published_recently_with_recent(self):
        """
        was_published_recently() should return True for questions whose pub date within a day
        """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with a pub_date in the futrue should not be displayed on the index page.
        """
